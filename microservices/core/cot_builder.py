...
def build_cot_event(uid, cot_type, lat, lon, callsign, remarks="", color="-16776961",
                    stale_minutes=60, hae="0", course=None, speed_mps=None, image_hash=None):
    ...
    # image_hash wurde bisher entgegengenommen, aber nie verwendet.
    # Verlinkung des bereits per /Marti/sync/upload hochgeladenen Bildes
    # ueber den ATAK-File-Sync-Hash.
    if image_hash:
        ET.SubElement(detail, "attachment_list", {"hashes": f'["{image_hash}"]'})
